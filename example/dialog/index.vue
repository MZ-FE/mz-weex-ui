...
<template>
  <div class="mz-demo">
    <scroller class="scroller">
      <title title="mz-dialog"></title>
      <category title="Dialog配置"></category>
      <mz-cell :has-top-border="false" title="标题文案">
        <input class="input"
               slot="value"
               placeholder="请输入标题"
               :value="title"
      ...
      <mz-cell :has-top-border="false" title="说明文案">
        <input class="input"
               slot="value"
               placeholder="请输入说明内容"
               :value="content"
      ...
      <mz-cell :has-top-border="false" title="主按钮">
        <input class="input"
               slot="value"
               placeholder="确定按钮文案"
               :value="confirmText"
      ...
      <mz-cell :has-top-border="false" title="副按钮">
        <input class="input"
               slot="value"
               placeholder="取消按钮文案"
               :value="cancelText"
    ...
    <mz-dialog :title="title"
                ...
                @wxcDialogNoPromptClicked="dialogNoPromptClick"></mz-dialog>
  </div>
</template>
